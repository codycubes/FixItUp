  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h1 className='text-4xl text-center text-white mb-10'>Register</h1>
        <form className='flex flex-col items-center justify-center mt-4'>
            <input type="text" placeholder="Name" className='mb-5 p-2 rounded w-80'/>
            ...
            <button type="submit" className='bg-[#055992] text-white mb-2 p-2 rounded w-80'>Register</button>
            <p className='text-sm text-white'>Already registered? <span className='underline'>Sign in</span></p>
        </form>
      </div>
    </div>
    </>
